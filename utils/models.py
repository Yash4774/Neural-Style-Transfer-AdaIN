...
class VGGEncoder(nn.Module):
    def __init__(self, vgg_path):
        ...
        self.vgg.load_state_dict(torch.load(vgg_path, map_location='cpu', weights_only=False))

        self.vgg = nn.Sequential(*list(self.vgg.children())[:31])  # relu4-1 tak hi chahiye, uske baad ke layers nahi chahiye
